...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEF] = LAYOUT_split_3x5_3(
        ...
        KC_NO,     KC_NO,     KC_CAPS,   KC_SPC,    LA_NAV,           LA_SYM,    KC_LSFT,   LA_ALT,       KC_NO,       KC_NO
    ),
    ...
    [_GAM] = LAYOUT_split_3x5_3(
        ...
        KC_NO,     KC_NO,     KC_LALT,   KC_SPC,    LA_GFN,           DF(_DEF),  KC_SPC,    KC_PSCR,       KC_NO,       KC_NO
    ),
    ...
    [_GFN] = LAYOUT_split_3x5_3(
        ...
        KC_NO,     KC_NO,     KC_ESC,    KC_ENT,    _______,          _______,   _______,   _______,       KC_NO,       KC_NO
    ),
    ...
    [_ALT] = LAYOUT_split_3x5_3(
        ...
        KC_NO,     KC_NO,          _______,    NBSP,       _______,           _______,    _______,    _______,    KC_NO,        KC_NO
    ),
    ...
    [_NAV] = LAYOUT_split_3x5_3(
        ...
        KC_NO,     KC_NO,     _______,   LA_CMD,    _______,          _______,   _______,   _______,      KC_NO,       KC_NO
    ),
    ...
    [_CMD] = LAYOUT_split_3x5_3(
        ...
        KC_NO,     KC_NO,     _______,   _______,   _______,          KC_LGUI,   _______,   _______,      KC_NO,       KC_NO
    ),
